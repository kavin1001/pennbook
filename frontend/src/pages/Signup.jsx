...
function Signup() {
    ...
    const submitSignup = async () => {
        if (firstName === "" || lastName === "" || username === "" || password === "" || email === "" || affliation === "" || birthday === "") {
            alert("Must Fill Out All Fields");
            return;
        }
        
        if (userSelectedTags.length < 2) {
            alert("Must Select At Least 2 Tags");
            return;
        }
    ...
    return (
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            ...
            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" type="text" placeholder="Affliation" value={affliation} onChange={e => setAffliation(e.target.value)}/>
            </div>
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
